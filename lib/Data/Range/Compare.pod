...
This package is a extensible framework for finding intersections between two dimensional ranges of data.

Data::Range::Compare is not intended to be used directly although you can.  For the most part it is intended to be subclassed by other packages.
